...
import dev.resolvt.api.rest.Error
...
class PluginAuthenticationFilter(
    ...
    override fun doFilterInternal(request: HttpServletRequest, response: HttpServletResponse, filterChain: FilterChain) {
        try {
            ...
            response.writeError(dev.resolvt.api.rest.Error("token_expired", "Token expired"))
        }
    }

    private fun HttpServletResponse.writeError(error: dev.resolvt.api.rest.Error) {
